<template>
  <div class="form-group row align-items-center">
    <label :for="getSelectId" :class="`${labelClasss} ${getLabelclass} text-dark`" v-if="label">{{ label }}</label>
    <div :class="`relative ${getFieldclass}`">
      <div class="d-flex">
        <select v-if="!loader" :id="getSelectId" class="form-control" @change="$emit('input', $event.target.value)" :disabled="disabled" :class="{ 'bg-light': disabled }">
