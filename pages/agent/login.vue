            ...
            <div class="card login-card overflow-hidden">
              <div class="bg-primary">
                <div class="text-primary text-center p-4">
                  ...
                  <p class="text-white-50 mb-0">Sign in to continue on Sozashop For Agent</p>
                </div>
              </div>
                  ...
                  <form class="form-horizontal mt-4" autocomplete="off" @submit.prevent="login">
                    ...
                    <div class="">
                      ...
                      <p class="mt-3 mb-2 text-center">
                        <nuxt-link class="btn btn-info font-weight-bold" :to="localePath('/agent/register')" style="letter-spacing: 0.5px;">
                          Register now
                        </nuxt-link>
                      </p>
                    </div>
  ...
  methods: {
    async login() {
      ...
      try {
        ...
        this.$router.push(this.localeRoute("/agent"));
      } catch (error) {
